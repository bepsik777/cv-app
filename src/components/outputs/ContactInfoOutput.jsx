      ...
      <ul className="contact-list">
        ...
        <li>
          <span>
            <svg
              ...
              stroke="currentColor"
              viewBox="0 0 24 24"
              className="humbleicons hi-mobile"
            >
              <path
                xmlns="http://www.w3.org/2000/svg"
                stroke="currentColor"
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M10 17h4m3-12v14a1 1 0 01-1 1H8a1 1 0 01-1-1V5a1 1 0 011-1h8a1 1 0 011 1z"
              />
            </svg>
          </span>
        ...
        <li>
          <svg
            ...
            stroke="currentColor"
            viewBox="0 0 24 24"
            className="humbleicons hi-location"
          >
            <path
              xmlns="http://www.w3.org/2000/svg"
              stroke="currentColor"
        ...
        <li>
          <span>
            <svg viewBox="0 0 128 128" className="linkedin-icon">
